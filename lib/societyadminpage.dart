...
class _SocietyAdminPageState extends State<SocietyAdminPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _descriptionController = TextEditingController(text: society?.description ?? '');
    _meetingRequirementController = TextEditingController(text: society?.meetingRequirement.toString() ?? '5');
  ...
  Future<String?> _uploadImage() async {
    ...
    try {
      final String fileName = '${DateTime.now().millisecondsSinceEpoch}_${path.basename(_imageFile!.path)}';
